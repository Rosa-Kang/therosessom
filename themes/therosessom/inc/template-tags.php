...
/**
  ...
  */
function therosessom_comment_count() {
...
if ( 'post' === get_post_type() ) {
  ...
  if ( $categories_list && therosessom_categorized_blog() ) {
...
/**
  ...
  * @return bool
  */
function therosessom_categorized_blog() {
if ( false === ( $all_the_cool_cats = get_transient( 'therosessom_categories' ) ) ) {
  ...
  set_transient( 'therosessom_categories', $all_the_cool_cats );
}

if ( $all_the_cool_cats > 1 ) {
  // This blog has more than 1 category so therosessom_categorized_blog should return true.
  return true;
} else {
  // This blog has only 1 category so therosessom_categorized_blog should return false.
  return false;
}
}

/**
  * Flush out the transients used in therosessom_categorized_blog.
  */
function therosessom_category_transient_flusher() {
if ( defined( 'DOING_AUTOSAVE' ) && DOING_AUTOSAVE ) {
  return;
}
// Like, beat it. Dig?
delete_transient( 'therosessom_categories' );
}
add_action( 'edit_category', 'therosessom_category_transient_flusher' );
add_action( 'save_post',     'therosessom_category_transient_flusher' );
...
*/
function therosessom_comment_list( $comment, $args, $depth ) {
...
*/
function therosessom_numbered_pagination() {
global $wp_query;
$big = 999999999;
